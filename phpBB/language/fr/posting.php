...
$lang = array_merge($lang, array(
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> 'Vos animations flash ne doivent pas dépasser %1$d pixel(s) de haut.',
	'MAX_FLASH_WIDTH_EXCEEDED'	=> 'Vos animations flash ne doivent pas dépasser %1$d pixel(s) de large.',
	...
	'MESSAGE_BODY_EXPLAIN'		=> 'Votre saisie ne doit pas contenir plus de <strong>%d</strong> caractère(s).',
	...
	'POLL_FOR_EXPLAIN'			=> 'Mettre « 0 » ou laissez vide pour une durée de sondage illimitée.',
	...
	'POLL_OPTIONS_EXPLAIN'		=> 'Placez chaque option sur une ligne différente. Vous ne pouvez saisir que <strong>%d</strong> option(s).',
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Placez chaque option sur une ligne différente. Vous ne pouvez saisir que <strong>%d</strong> option(s). Si vous supprimez ou ajoutez des options, tous les votes précédents seront remis à zéro.',
	...
	'QUOTE_DEPTH_EXCEEDED'		=> 'Le nombre d’imbrication de citations est limité à %1$d niveau(x).',
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> 'Mettre « 0 » ou laisser cette case vide pour épingler pour une durée illimitée un sujet en « Post-it » ou « Annonce ». Notez que ce nombre est relatif à la date de création du message.',
	...
	'TOO_MANY_CHARS_SIG'		=> 'Votre signature contient %1$d caractère(s). Le nombre maximum de caractères autorisés est %2$d.',
