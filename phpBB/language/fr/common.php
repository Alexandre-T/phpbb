...
$lang = array_merge($lang, array(
	...
	'NEW_PM'					=> '<strong>%d</strong> nouveau M.P.',
	'NEW_PMS'					=> '<strong>%d</strong> nouveaux M.P.',
	...
	'NO_MULTIPLAYERS'			=> 'Aucun multicompte',	
	'NO_NEW_MESSAGES'			=> 'Pas de nouveau message',
	'NO_NEW_PM'					=> '<strong>0</strong> nouveau M.P.',
	...
	'TOTAL_POSTS_ZERO'	=> '<strong>%d</strong> message',
	'TOPIC_REPORTED'	=> 'Ce sujet a été rapporté',
	'TOTAL_TOPICS_OTHER'=> '<strong>%d</strong> sujets',
	'TOTAL_TOPICS_ZERO'	=> '<strong>%d</strong> sujet',
	'TOTAL_USERS_OTHER'	=> '<strong>%d</strong> membres inscrits',
	'TOTAL_USERS_ZERO'	=> '<strong>%d</strong> membre inscrit',
	'TOTAL_RPS_OTHER'	=> '<strong>%d</strong> RPs actifs',
	'TOTAL_RPS_ZERO'	=> '<strong>%d</strong> RP actif',
	'TOTAL_ARCHIVES_OTHER'	=> '<strong>%d</strong> RPs terminés',
	'TOTAL_ARCHIVES_ZERO'	=> '<strong>%d</strong> RP terminé',
	'TOTAL_ACTIVES_OTHER'	=> '<strong>%d</strong> joueurs actifs',
	'TOTAL_ACTIVES_ZERO'	=> '<strong>%d</strong> joueur actif',
	...
	'WRONG_DATA_ICQ'			=> 'Le numéro que vous avez saisi n’est pas un numéro ICQ valide.',
