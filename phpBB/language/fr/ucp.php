...
$lang = array_merge($lang, array(
	...
	'PHILOSPHIE'			=> 'La philosophie du site',
	'PHILOSPHIE_TEXT'		=> 'En intégrant la communauté de Vegas-Elevation, vous participez à une œuvre légalement définie «d\'œuvre de collaboration». Tout ce que vous écrirez sera votre propriété intellectuelle et vous en serez l\'auteur. Comme le prévoit la loi, vous pourrez quitter le forum et exiger la suppression de vos messages en faisant usage de votre droit de repentir ou de retrait. Mais attention, un auteur ne peut interdire à sa maison d\'édition de publier les livres édités sans indemniser tant l\'acquéreur que l\'éditeur.
							<br/>
							Pour autant, il est inacceptable -- et illégal -- que d\'autres auteurs s\'octroient la paternité de vos textes ou vous empêchent de jouir de votre œuvre comme bon vous semble -- comme, par exemple, de publier vos œuvres sous forme de livre. Nous avons donc choisi de faire héberger ce forum en France, car les lois de ce pays sont celles qui protègent au mieux les auteurs, leurs œuvres mais aussi les œuvres dites de collaboration. Le droit de la propriété en France distingue deux droits essentiels : les droits moraux et les droits de patrimoine sur l\'œuvre créée. Ces droits protègent chaque partie : l\'auteur, son œuvre et son diffuseur.',

	'LAW'					=> 'Ce que prévoit la loi',
	'LAW_TEXT'				=> "En vous inscrivant sur le site Vegas-Elevation, vous participez à une œuvre de collaboration, comme définie à l'article <a href=\"http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278882\" title=\"L113-2\">L113-2</a> du code de la propriété intellectuelle «CPI».",

	'PROTECT_YOU'			=> 'Protéger votre création !',
	'PROTECT_YOU_TEXT'		=> 'Sachez que les droits moraux sont perpétuels, inaliénables, et imprescriptibles ! (Article <a href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278891" title="L121-1">L121-1</a> du CPI) Vous jouissez donc perpétuellement de vos droits au respect de votre œuvre (Article <a href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278891" title="L121-1">L121-1</a> du CPI), à la paternité de votre œuvre (Article <a href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278891" title="L121-1">L121-1</a> du CPI), ainsi que de vos droits retrait ou de repentir (Article <a href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278894" title="L121-4">L121-4</a> du CPI) et de divulgation (Article <a href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278892" title="L121-2">L121-2</a> du CPI).',

	'PROTECT_US'			=> 'Protéger le site !',
	'PROTECT_US_TEXT'		=> 'Ce sont les droits de patrimoine et donc d\'exploitation qui sont cessibles sous couvert de l\'autorisation de l\'auteur (Article <a href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278904" title="L122-2">L122-2</a> du CPI). Le droit d\'exploitation couvre le droit de reproduction et le droit de représentation d\'une œuvre (Article <a title="L122-7" href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278922">L122-7</a> du CPI). Le droit de reproduction concerne une diffusion indirecte au public  par le biais d\'un support matériel (Article <a title="122-3" href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278907">122-3</a> du CPI). Le droit de représentation est une diffusion directe au public (Article <a title="122-2" href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278904">122-2</a> du CPI). Participer aux écrits et publier des contributions sur ce site sous-entend que vous consentez à octroyer gracieusement un droit de représentation de votre œuvre aux propriétaires de ce site sans limitation dans le temps. Vous nous octroyez donc le droit de diffuser votre œuvre sur ce site. Si vous souhaitez faire usage de vos droits de retrait ou de repentir et retirer de ce site les contributions que vous y avez publiées, il faudra le faire en conformité avec l\'article suivant du CPI <a title="L121-4" href="http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278894">L121-4</a>. Soyons clairs, cet article de loi signifie qu\'exercer votre droit de retrait ou de repentir vous incombera de dédommager la communauté à hauteur du préjudice subit.',
	'PARTICIPATE'			=> 'Participer à ce site !',
	'PARTICIPATE_TEXT'		=> 'En publiant sur ce site, vous consentez gracieusement un droit de représentation à Vegas-Elevation des œuvres que vous publiez sur ce site de diffusion Internet. Cela ne vous empêche nullement d\'exploiter séparément votre contribution personnelle sur d\'autres sites ou sur tout autre support, conformément à l\'article <a title="L113-3" href=http://legifrance.gouv.fr/affichCodeArticle.do?idArticle=LEGIARTI000006278883">L113-3</a> du CPI. ',
	...
	// Protection des mineurs (SONGES)
	'WARNING_CHILD'			=> 'Protection des mineurs',
	'WARNING_CHILD_TXT'		=> '
	Ce site est réservé à un public majeur et averti et est conforme à toutes les réglementations françaises en vigueur. Il contient des textes et des photos érotiques et/ou pornographiques qui peuvent heurter la sensibilité d\'un public inadapté.<br /><br />
	
	Ainsi, je certifie sur l\'honneur :<br />
	- être majeur selon la loi en vigueur dans mon pays,<br />
	- que les lois de mon pays m\'autorisent à accéder à ce forum,<br />
	- être informé du caractère érotique ou pornographique du forum auquel j\'accède,<br />
	- je déclare n\'être choqué par aucun type de sexualité et m\'interdit de poursuivre les fondateurs de Vegas-Elevation de toute action judiciaire,<br />
	- consulter ce forum à titre personnel sans impliquer de quelque manière que ce soit une société privée ou un organisme public.<br /><br />

	Je m\'engage sur l\'honneur à :<br />
	- ne pas faire état de l\'existence de ce forum, et à ne pas en diffuser le contenu à des mineurs,<br />
	- utiliser tous les moyens permettant d\'empêcher l\'accès à ce forum à un mineur,<br />
	- assumer ma responsabilité, si un mineur accède à ce forum à cause de négligences de ma part : absence de protection de l\'ordinateur personnel, absence de logiciel de censure, divulgation ou perte du mot de passe de sécurité...,<br />
	- assumer ma responsabilité si une ou plusieurs de mes présentes déclarations sont inexactes.<br /><br />

	En aucun cas le webmaster ou la prestataire de service ne pourront faire l\'objet de poursuites judiciaires pour des préjudices moraux que les photos ou les vidéos pourraient engendrer chez un public mineur ou inadapté.<br />
	Toutes les images contenues dans ce forum sont en accord avec la loi Française sur la pornographie (aucune image à caractère sexuel contenant des mineurs n\'est présente sur ce forum).<br /><br />
	
	<center><img src="http://silies.free.fr/divers/gehi2/warning_child.jpg" alt="Protection de l\'enfance"/></center><br/><br/>
	',
...
$lang = array_merge($lang, array(
	...
	'FIELD_TOO_SHORT'					=> 'Le contenu du champ « %1$s » est trop court, il doit comporter au moins %2$d caractère(s).',
	'FIELD_TOO_LONG'					=> 'Le contenu du champ « %1$s » est trop long, il ne peut comporter plus %2$d caractère(s).',
	...
	'FIELD_INVALID_CHARS_SPACERS_ONLY'	=> 'Le champ « %s » comporte des caractères non valides, seuls les caractères alphanumériques (A-Z, 0-9), les espaces ou les caractères - + _ [ ] sont autorisés.',
	...
	'FOLDER_STATUS_MSG'			=> 'Dossier rempli à %1$d%% (%2$d sur %3$d messages)',
	...
	'MOVE_PM_ERROR'					=> 'Une erreur est survenue en déplaçant les messages vers le nouveau dossier, seuls %1$d des %2$d messages ont été déplacés.',
	...
	'NOT_MOVED_MESSAGE'				=> 'Vous avez actuellement un message privé en attente car le dossier est plein.',
	'NOT_MOVED_MESSAGES'			=> 'Vous avez %d messages privés en attente car le dossier est plein.',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Le mot de passe doit avoir une longueur comprise entre %1$d et %2$d caractères et doit contenir des lettres de casse mélangée (majuscules et minuscules) et des chiffres.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Le mot de passe doit avoir une longueur comprise entre %1$d et %2$d caractères.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Le mot de passe doit avoir une longueur comprise entre %1$d et %2$d caractères et doit contenir des lettres de casse mélangée (majuscules et minuscules).',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Le mot de passe doit avoir une longueur comprise entre %1$d et %2$d caractères et doit contenir des lettres de casse mélangée (majuscules et minuscules), des chiffres et des symboles.',
	...
	'USERNAME_ALPHA_ONLY_EXPLAIN'	=> 'Le nom d’utilisateur doit avoir une longueur comprise entre %1$d et %2$d caractères et ne doit contenir que des caractères alphanumériques.',
	'USERNAME_ALPHA_SPACERS_EXPLAIN'		=> 'Le nom d’utilisateur doit avoir une longueur comprise entre %1$d et %2$d caractères et ne doit contenir que des caractères alphanumériques, des espaces ou les caractères - + _ [ ]',
	'USERNAME_ASCII_EXPLAIN'				=> 'Le nom d’utilisateur doit avoir une longueur comprise entre %1$d et %2$d caractères et ne doit contenir que des caractères ASCII (pas de symboles spéciaux).',
	'USERNAME_LETTER_NUM_EXPLAIN'			=> 'Le nom d’utilisateur doit avoir une longueur comprise entre %1$d et %2$d caractères et ne doit contenir que des lettres ou des chiffres.',
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'	=> 'Le nom d’utilisateur doit avoir une longueur comprise entre %1$d et %2$d caractères et peut contenir des lettres, des chiffres, des espaces ou les caractères - + _ [ ]',
	'USERNAME_CHARS_ANY_EXPLAIN'			=> 'Le nom d’utilisateur doit avoir une longueur comprise entre %1$d et %2$d caractères.',
