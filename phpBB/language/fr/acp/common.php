...
$lang = array_merge($lang, array(
	...
	'LOG_POST_EDITED'			=> '<strong>Modification du message « %1$s » écrit par</strong><br />» %2$s',
	...
	'LOG_IMAGESET_ADD_DB'			=> '<strong>Ajout du pack d’images dans la base de données</strong><br />» %s',
	'LOG_IMAGESET_ADD_FS'			=> '<strong>Ajout du pack d’images dans le système de fichiers</strong><br />» %s',
	'LOG_IMAGESET_DELETE'			=> '<strong>Suppression du pack d’images</strong><br />» %s',
	'LOG_IMAGESET_EDIT_DETAILS'		=> '<strong>Modification des informations du pack d’images</strong><br />» %s',
	'LOG_IMAGESET_EDIT'				=> '<strong>Modification du pack d’images</strong><br />» %s',
	'LOG_IMAGESET_EXPORT'			=> '<strong>Exportation du pack d’images</strong><br />» %s',
	'LOG_IMAGESET_LANG_MISSING'		=> '<strong>Traduction manquante « %2$s » pour le pack d’images</strong><br />» %1$s',
	'LOG_IMAGESET_LANG_REFRESHED'	=> '<strong>Rafraîchissement de la traduction « %2$s » du pack d’images</strong><br />» %1$s',
	'LOG_IMAGESET_REFRESHED'		=> '<strong>Rafraîchissement du pack d’images</strong><br />» %s',
	...
	'LOG_WARNINGS_DELETED'		=> '<strong>Suppression de %2$s avertissements donnés au membre</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
