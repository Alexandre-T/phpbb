...
class fulltext_mysql extends search_backend
{
	...
	* @access	public
	*/
	function author_search($type, $firstpost_only, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $m_approve_fid_ary, $topic_id, $author_ary, $author_name, &$id_ary, $start, $per_page, $topic_type=3, $topic_status = 2)
	{
		global $config, $db;
		// No author? No posts.
		...
		switch ($topic_type){
			case 0 :
				...
				break;
			case 1 :
				$sql_topic_type = ' AND ' . $db->sql_in_set('t.topic_type', array(0,1));
				break;
			case 2 :
				$sql_topic_type = ' AND ' . $db->sql_in_set('t.topic_type', array(0,2));
				break;
			default :
				$sql_topic_type ='';
		}		
